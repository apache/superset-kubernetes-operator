...
- Kubernetes 1.25+ (<!-- BEGIN SUPPORTED-K8S-INLINE -->1.37, 1.36, 1.35<!-- END SUPPORTED-K8S-INLINE --> officially tested; 1.29+ recommended so CEL validation is GA — see [supported versions](user-guide/installation.md#supported-kubernetes-versions))
- Helm 4
