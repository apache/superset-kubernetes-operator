...
- **Lifecycle automation** — pre-upgrade backups, database seeding, schema migrations, secret key rotation, and application init run as sequenced tasks with automatic change detection and checksum-based re-execution
