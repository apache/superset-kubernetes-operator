...
Officially tested against the two most recent Kubernetes minor versions that
have published kind node images. The newest Kubernetes release receives
best-effort coverage via a non-blocking CI lane until kind publishes its
corresponding node image.
