...
- `internal/controller/` — Reconciler implementations
  ...
  - `lifecycle_backup.go` — Backup task: settled-baseline checksum, guard placement, dump scripts, Job spec
